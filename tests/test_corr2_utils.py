...
class TestCorr2Utils(unittest.TestCase):
    def setUp(self):
        ...
        self.dict2 = {'file_name': 'f1.dat', 'do_auto_corr': True, 'do_cross_corr': False, 
                      'file_name2': 'f2.dat', 'rand_file_name': 'r1.dat', 
                      ...
                      'split_method': 'median'} 
        # OK if check_status=False, fails if check_status = True; this one also checks the 
        # type-checking by passing some things as strings
        self.dict3 = {'file_name': 'f1.dat', 'do_auto_corr': 'True', 'do_cross_corr': 'False',      
                      'file_name2': 'f2.dat', 'rand_file_name': 'r1.dat', 
                      'rand_file_name2': 'r2.dat','file_list': 'fl1.dat', 'file_list2': 'fl2.dat', 
                      'rand_file_list': 'rl1.dat', 'rand_file_list2': 'rl2.dat', 
                      'file_type': 'ASCII', 'delimiter': ' ', 'comment_marker': '#', 
                      'first_row': '0', 'last_row': '10', 'x_col': '3', 'y_col': '4', 
                      'ra_col': '5', 'dec_col': '6', 'x_units': 'arcsec', 'y_units': 'arcsec', 
                      'ra_units': 'degrees', 'dec_units': 'degrees', 'g1_col': '7', 'g2_col': '8', 
                      'k_col': '9', 'w_col': '10', 'flip_g1': 'False', 'flip_g2': 'False', 
                      'pairwise': 'False', 'project': 'False', 'project_ra': '0', 
                      'project_dec': '0', 'min_sep': '0.1', 'max_sep': '10', 'nbins': '10', 
                      'bin_size': '0.99', 'sep_units': 'degrees', 'bin_slop': '0.8', 
                      'smooth_scale': '1', 'n2_file_name': 'o1.dat', 'n2_statistic': 'compensated', 
                      'ng_file_name': 'o2.dat', 'ng_statistic': 'compensated', 
                      'g2_file_name': 'o3.dat', 'nk_file_name': 'o4.dat', 'nk_statistic': 'simple', 
                      'k2_file_name': 'o5.dat', 'kg_file_name': 'o6.dat', 'precision': 3, 
                      'm2_file_name': 'o7.dat', 'm2_uform': 'Crittenden', 'nm_file_name': 'o8.dat', 
        ...
        self.dict4 = {'file_name': 'f1.dat', 'do_auto_corr': '3', 'do_cross_corr': 'False', 
                      'file_name2': 'f2.dat', 'rand_file_name': 'r1.dat', 
                      'rand_file_name2': 'r2.dat', 'file_list': 'fl1.dat', 'file_list2': 'fl2.dat', 
                      'rand_file_list': 'rl1.dat', 'rand_file_list2': 'rl2.dat', 
                      'file_type': 'ASCII', 'delimiter': ' ', 'comment_marker': '#', 
                      ...
                      'ng_file_name': 'o2.dat', 'ng_statistic': 'compensated', 
                      'g2_file_name': 'o3.dat', 'nk_file_name': 'o4.dat', 'nk_statistic': 'simple', 
                      'k2_file_name': 'o5.dat', 'kg_file_name': 'o6.dat', 'precision': 'yellow', 
                      'm2_file_name': 'o7.dat', 'm2_uform': 'Crittenden', 'nm_file_name': 'o8.dat', 
                      'norm_file_name': 'o9.dat', 'verbose': '3', 'num_threads': '16', 
                      'split_method': 'median'} 
        # Should fail some of the value checks (file_type and m2_uform)
        self.dict5 = {'file_name': 'f1.dat', 'do_auto_corr': True, 'do_cross_corr': False, 
                      'file_name2': 'f2.dat', 'rand_file_name': 'r1.dat', 
                      'rand_file_name2': 'r2.dat', 'file_list': 'fl1.dat', 'file_list2': 'fl2.dat', 
                      'rand_file_list': 'rl1.dat', 'rand_file_list2': 'rl2.dat', 
                      'file_type': 'Unicode', 'delimiter': ' ', 'comment_marker': '#', 
                      'first_row': 0, 'last_row': 10, 'x_col': 3, 'y_col': 4, 'ra_col': 5, 
                      'dec_col': 6, 'x_units': 'arcsec', 'y_units': 'arcsec', 
                      'ra_units': 'degrees', 'dec_units': 'degrees', 'g1_col': 7, 'g2_col': 8, 
                      'k_col': 9, 'w_col': 10, 'flip_g1': False, 'flip_g2': False, 
                      ...
                      'g2_file_name': 'o3.dat', 'nk_file_name': 'o4.dat', 'nk_statistic': 'simple', 
                      'k2_file_name': 'o5.dat', 'kg_file_name': 'o6.dat', 'precision': 3, 
                      'm2_file_name': 'o7.dat', 'm2_uform': 'Swindon', 'nm_file_name': 'o8.dat', 
                      'norm_file_name': 'o9.dat', 'verbose': 3, 'num_threads': 16, 
                      'split_method': 'median'} 
        # Should pass even with check_status = True
        self.dict6 = {'flip_g1': False, 'flip_g2': False, 'project': False, 'project_ra': 0, 
                      'project_dec': 0, 'min_sep': 0.1, 'max_sep': 10, 'nbins': 10, 
                      'bin_size': 0.99, 'sep_units': 'degrees', 'bin_slop': 0.8, 'precision': 3, 
                      'm2_uform': 'Crittenden', 'split_method': 'median'} 
    ...
    def compare_text_files(self, f1, f2, reorder=True):
        """
        Compare the contents of two text files. Any whitespace on a line is converted to a single
        space, and beginning/ending whitespace is stripped along with blank lines.  The files are 
        then sorted (if reorder=True, the default), and the resulting arrays compared line-by-line.
        ...
        @returns       True if the files are the same (modulo whitespace/blank lines/order as 
    ...
    def test_CheckArguments(self):
        ...
        self.assertRaises(ValueError,stile.corr2_utils.CheckArguments,self.dict1,check_status=True)
        self.assertRaises(ValueError,stile.corr2_utils.CheckArguments,self.dict2,check_status=True)
        self.assertRaises(ValueError,stile.corr2_utils.CheckArguments,self.dict3,check_status=True)
        self.assertRaises(ValueError,stile.corr2_utils.CheckArguments,self.dict4,check_status=True)
        self.assertRaises(ValueError,stile.corr2_utils.CheckArguments,self.dict4,check_status=False)
        self.assertRaises(ValueError,stile.corr2_utils.CheckArguments,self.dict5,check_status=True)
    ...
    def test_WriteCorr2ConfigurationFile(self):
        ...
        stile.WriteCorr2ConfigurationFile(f2,self.dict2)
        self.assertTrue(self.compare_text_files(f2,'test_data/corr2_dict2_config_file.dat'),
                        msg=('WriteCorr2ConfigurationFile() produced incorrect output for test '+
                             'args dict2; check file %s for problems (can be removed after)'%f2))
        os.close(handle)
        os.remove(f2)
    ...
    def test_OSFile(self):
        ...
        numpy.testing.assert_equal(*helper.FormatSame(result,arr2))
        ...
        numpy.testing.assert_equal(*helper.FormatSame(result,arr2[['two','three','one']]))
        result = stile.ReadTable(OSFile5.file_name,fields=['two','three','one'])
        numpy.testing.assert_equal(*helper.FormatSame(result,arr2[['two','three','one']]))
        self.assertEqual(OSFile6,OSFile2) 
    ...
    def test_MakeCorr2FileKwargs(self):
        ...
        self.assertIn('ra_col',result)
        self.assertIn('dec_col',result)
        self.assertIn('g1_col',result)
        self.assertIn('g2_col',result)
        self.assertIsInstance(result['file_name'],stile.corr2_utils.OSFile)
        numpy.testing.assert_equal(*helper.FormatSame(
        ...
        self.assertIn('g1_col',result)
        self.assertIn('g2_col',result)
        self.assertEqual(result['file_name'],'test_data/data_table.dat')
        numpy.testing.assert_equal([result['ra_col'],result['dec_col'],result['g1_col'],
        ...
        self.assertIn('file_name',result)
        self.assertIn('file_name2',result)
        self.assertIn('ra_col',result)
        self.assertIn('dec_col',result)
        self.assertIn('g1_col',result)
        self.assertIn('g2_col',result)
        self.assertIsInstance(result['file_name2'],stile.corr2_utils.OSFile)
        numpy.testing.assert_equal(*helper.FormatSame(
                                        stile.ReadASCIITable('test_data/data_table.dat'),
        ...
        numpy.testing.assert_equal(*helper.FormatSame(result2,
                                   stile.ReadASCIITable('test_data/data_table.dat')))
        numpy.testing.assert_equal([result['ra_col'],result['dec_col'],result['g1_col'],
        ...
        self.assertIn('g1_col',result)
        self.assertIn('g2_col',result)
        self.assertTrue(isinstance(result['file_name'],stile.corr2_utils.OSFile) or 
                        isinstance(result['file_name2'],stile.corr2_utils.OSFile),
                        msg='At least one of the files should have been made into an OSFile')
        self.assertFalse(isinstance(result['file_name'],stile.corr2_utils.OSFile) and
                         isinstance(result['file_name2'],stile.corr2_utils.OSFile),
                         msg='Only one of the files should have been made into an OSFile')
        ...
        result_file_names = stile.ReadTable(str(result['file_list']))
        self.assertEqual(len(result_file_names.dtype.names),2)
        self.assertTrue(result_file_names['f0'][0]=='test_data/data_table.dat' or 
                        result_file_names['f1'][0]=='test_data/data_table.dat',
                        msg='Both files rewritten (should have been one)')
        self.assertNotEqual(result_file_names['f0'][0],result_file_names['f1'][0],
                            msg='Filenames should be different, but are the same')
        ...
        numpy.testing.assert_equal(*helper.FormatSame(result2,result3))
        ...
        self.assertIn('g1_col',result)
        self.assertIn('g2_col',result)
        self.assertEqual(osfile,result['file_name'])
