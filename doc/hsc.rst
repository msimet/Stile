...
- **StileCCDNoTract.py**: run on one or more CCDs individually, without using any tract-level
  information such as background fits
- **StileVisit.py**: run on one or more visits individually (that is, analyze all CCDs from a visit
  at once)
