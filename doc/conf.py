# -*- coding: utf-8 -*-
#
# Stile documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'stile', u'Stile Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Stile', u'Stile Documentation',
   author, 'Stile', 'One line description of project.',
   'Miscellaneous'),
]
